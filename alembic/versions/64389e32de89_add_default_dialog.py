...
Revision ID: 64389e32de89
Revises: d539580d3829
Create Date: 2025-08-12 20:33:50.217416
...
from sqlalchemy import UUID, Table, Column, ForeignKey, DateTime, func, MetaData, false, delete
from sqlalchemy.orm import Mapped, relationship, mapped_column, DeclarativeBase, Session

# revision identifiers, used by Alembic.
revision: str = '64389e32de89'
down_revision: Union[str, None] = 'd539580d3829'
...
def upgrade() -> None:
    ...
    default_dialog = GiveawayORM(
        ...
        success_text="Успех!",
        integration_url="https://example.com/giveaway",
    )
